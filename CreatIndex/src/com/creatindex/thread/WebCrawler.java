...
public class WebCrawler extends Thread {
	...
	List<String> allurlSet = new ArrayList<String>();// 所有的网页url，需要更高效的去重可以考虑HashSet
	List<String> notCrawlurlSet = new ArrayList<String>();// 未爬过的网页url
